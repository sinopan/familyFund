...
public class FastJsonUtils {
	/*** * 解析为字符串 * * @param jsonString * @param key * @return */
	...
	/*** * 解析为布尔 * * @param jsonString * @param key * @return */
	...
	/*** * 解析为String * * @param jsonString * @param key * @return */
	...
	/*** * 解析为Int * * @param jsonString * @param key * @return */
	...
	/*** * 解析为数字 * * @param jsonString * @param key * @return */
	...
	/*** * 解析为长位十进制数 * * @param jsonString * @param key * @return */
	...
	/*** * 解析为双精度 * * @param jsonString * @param key * @return */
	...
	/*** * 解析为浮点数 * * @param jsonString * @param key * @return */
	...
	/***
	 * * 解析为对象 * * @param jsonString * @param key * @param t * @param
	 * <T> * @return
	 */
	...
	/***
	 * * 解析为列表 * * @param jsonString * @param key * @param t * @param
	 * <T> * @return
	 */
	...
	/*** * 直接解析为bean * * @param jsonString * @param t * @param <T> * @return */
	...
	/*** * 直接解析为list * * @param jsonString * @param t * @param <T> * @return */
